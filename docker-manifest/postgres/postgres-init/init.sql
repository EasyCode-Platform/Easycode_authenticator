...
alter table teams owner to easycode_authenticator;
-- users
...
alter table users owner to easycode_authenticator;
-- team_members
...
alter table team_members owner to easycode_authenticator;
-- invites
...
alter table invites owner to easycode_authenticator;
/**
 * Role Management
 *
 *
