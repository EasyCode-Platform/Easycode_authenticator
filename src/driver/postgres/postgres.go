...
type PostgresConfig struct {
	Addr     string `env:"EasyCode_SUPERVISOR_PG_ADDR" envDefault:"localhost"`
	Port     string `env:"EasyCode_SUPERVISOR_PG_PORT" envDefault:"5432"`
	User     string `env:"EasyCode_SUPERVISOR_PG_USER" envDefault:"ec_authenticator"`
	Password string `env:"EasyCode_SUPERVISOR_PG_PASSWORD" envDefault:"scut2023"`
	Database string `env:"EasyCode_SUPERVISOR_PG_DATABASE" envDefault:"ec_authenticator"`
}
